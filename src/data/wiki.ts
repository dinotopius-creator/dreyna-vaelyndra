...
export const WIKI_ARTICLES: WikiArticle[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Les items peuvent être payés en Eclats ou en Aureons selon leur rareté.",
    ...
    tips: [
      "Eclats = monnaie gratuite/non premium, utile pour beaucoup d'achats cosmétiques.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Les récompenses communautaires peuvent accorder des Eclats quand la synchronisation serveur est déclenchée.",
    ],
    tips: [
  ...
  {
    slug: "dons-offrandes",
    title: "Dons, offrandes, Eclats et Aureons",
    category: "Économie",
    audience: "Tous",
    status: "available",
    route: "/boutique",
    summary:
      "Eclats et Aureons servent à acheter, offrir et soutenir. Les Eclats sont la monnaie gratuite/non premium ; les Aureons sont la monnaie premium.",
    steps: [
      "Achetez ou obtenez des Eclats selon les offres disponibles dans la boutique et les récompenses quotidiennes.",
    ...
    tips: [
      "Les achats en Eclats ne donnent pas d'XP streamer lorsqu'ils sont offerts en item ; le code évite les abus entre comptes.",
