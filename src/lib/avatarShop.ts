...
export const SHOP_CATALOG: ShopItem[] = [
  ...
  },
  {
    ...
    category: "background",
    name: "Émeraude",
    description: "Vert profond, l'écho des forêts de PulseForge.",
    icon: "🌲",
    currency: "lueurs",
    price: 150,
  ...
  },
  {
    ...
    category: "background",
    name: "Mousse elfique",
    description: "Vert mousse doux, sous-bois de PulseForge.",
    icon: "🍃",
    currency: "lueurs",
    price: 145,
  ...
  },
  {
    ...
    category: "frame",
    name: "Comète vive",
    description: "Trace céleste pour les profils plus nerveux.",
    icon: "☄️",
    currency: "lueurs",
    price: 260,
    frameGlyph: "☄️",
  },
  {
    ...
    category: "frame",
    name: "Badge studio",
    description: "Signal créatif parfait pour les artistes et streamers.",
    icon: "🎬",
    currency: "sylvins",
    price: 28,
    frameGlyph: "🎬",
  ...
  {
    id: "scene-moon-garden",
    category: "scene",
    name: "Jardin lunaire",
    description: "Herbes bleutées, lune douce et fleurs nocturnes animées.",
    icon: "🌙",
    currency: "lueurs",
    price: 390,
    sceneId: "moon-garden",
  ...
  {
    id: "scene-crystal-studio",
    category: "scene",
    name: "Studio cristal",
    description: "Éclats prismatiques et halo clair pour les portraits nets.",
    icon: "💎",
    currency: "lueurs",
    price: 430,
    sceneId: "crystal-studio",
  },
  {
    id: "scene-throne-light",
    category: "scene",
    name: "Lumière du trône",
    description: "Rideau royal doré, idéal pour une présence premium.",
    icon: "👑",
    currency: "sylvins",
    price: 48,
    sceneId: "throne-light",
  },
  {
    id: "scene-starlit-balcony",
    category: "scene",
    name: "Balcon étoilé",
    description: "Nuit profonde, étoiles lentes et reflets de palais.",
    icon: "✨",
    currency: "sylvins",
    price: 52,
    sceneId: "starlit-balcony",
  },
  {
    id: "scene-neon-arcade",
    category: "scene",
    name: "Arcade néon",
    description: "Lignes cyan et rose pour les profils gaming.",
    icon: "🕹️",
    currency: "sylvins",
    price: 58,
    sceneId: "neon-arcade",
  ...
  },
  {
    ...
    description: "Silhouette verte noble inspiree des jardins de PulseForge.",
    icon: "🌿",
    currency: "lueurs",
    price: 540,
  ...
  },
  {
    ...
    category: "outfit3d",
    name: "Manteau braise",
    description: "Palette chaude et présence théâtrale pour la scène.",
    icon: "🔥",
    currency: "sylvins",
    price: 96,
  ...
  },
  {
    ...
    category: "outfit3d",
    name: "Manteau givré",
    description: "Bleu glace et reflets argentés pour un style hivernal.",
    icon: "❄️",
    currency: "lueurs",
    price: 560,
    wearableThemeId: "frost",
  },
  {
    id: "outfit3d-rose",
    category: "outfit3d",
    name: "Robe rosée",
    description: "Coupe douce, pétales et accents de scène romantique.",
    icon: "🌹",
    currency: "lueurs",
    price: 580,
    wearableThemeId: "rose",
  },
  {
    id: "outfit3d-oracle",
    category: "outfit3d",
    name: "Tenue d'oracle",
    description: "Violet profond, détails sacrés et silhouette cérémonielle.",
    icon: "🔮",
    currency: "sylvins",
    price: 112,
    wearableThemeId: "oracle",
  },
  {
    id: "outfit3d-street",
    category: "outfit3d",
    name: "Veste street royal",
    description: "Look moderne, lisible en live et très mobile-first.",
    icon: "🧥",
    currency: "lueurs",
    price: 610,
    wearableThemeId: "street",
  },
  {
    id: "outfit3d-ceremony",
    category: "outfit3d",
    name: "Habit de cérémonie",
    description: "Drapé ivoire et or pour les profils officiels.",
    icon: "🕯️",
    currency: "sylvins",
    price: 128,
    wearableThemeId: "ceremony",
  },
  {
    id: "outfit3d-neon",
    category: "outfit3d",
    name: "Combinaison néon",
    description: "Cyan lumineux et coupe arcade pour les lives dynamiques.",
    icon: "💠",
    currency: "sylvins",
    price: 118,
    wearableThemeId: "neon",
  },
  {
  ...
  {
    id: "accessory3d-rose-circlet",
    category: "accessory3d",
    name: "Diadème rosé",
    description: "Petit cercle floral posé sur la tête.",
    icon: "🌹",
    currency: "lueurs",
    price: 440,
    wearableThemeId: "rose-circlet",
    wearableFamily: "Couronnes",
  },
  {
    id: "accessory3d-crystal-mask",
    category: "accessory3d",
    name: "Masque cristal",
    description: "Demi-masque cyan pour un rendu mystique et net.",
    icon: "💎",
    currency: "sylvins",
    price: 92,
    wearableThemeId: "crystal-mask",
    wearableFamily: "Masques",
  },
  {
    id: "accessory3d-sun-halo",
    category: "accessory3d",
    name: "Halo solaire",
    description: "Anneau doré plus intense, visible dans les scènes claires.",
    icon: "☀️",
    currency: "sylvins",
    price: 106,
    wearableThemeId: "sun-halo",
    wearableFamily: "Halos",
  },
  {
    id: "accessory3d-ribbon",
    category: "accessory3d",
    name: "Ruban royal",
    description: "Ruban rose discret pour un avatar plus doux.",
    icon: "🎀",
    currency: "lueurs",
    price: 390,
    wearableThemeId: "ribbon",
    wearableFamily: "Ornements",
  },
  {
    id: "accessory3d-star-tiara",
    category: "accessory3d",
    name: "Tiare étoilée",
    description: "Petites pointes lumineuses pour les profils célestes.",
    icon: "⭐",
    currency: "sylvins",
    price: 84,
    wearableThemeId: "star-tiara",
    wearableFamily: "Couronnes",
  },
  {
    id: "accessory3d-onyx-horns",
    category: "accessory3d",
    name: "Cornes d'onyx",
    description: "Version sombre et plus élégante des cornes draconiques.",
    icon: "🖤",
    currency: "sylvins",
    price: 96,
    wearableThemeId: "onyx-horns",
    wearableFamily: "Cornes",
  },
  {
    id: "frame-lily-crown",
    category: "frame",
    name: "Lys lumineux",
    description: "Fleur claire en bord de portrait, douce et royale.",
    icon: "🌼",
    currency: "lueurs",
    price: 250,
    frameGlyph: "🌼",
  ...
  {
    id: "frame-sapphire-drop",
    category: "frame",
    name: "Goutte saphir",
    description: "Éclat bleu posé comme une signature précieuse.",
    icon: "💧",
    currency: "lueurs",
    price: 270,
    frameGlyph: "💧",
  },
  {
    ...
    category: "frame",
    name: "Sceau royal",
    description: "Marque dorée pour les profils de prestige.",
    icon: "🏵️",
    currency: "sylvins",
    price: 38,
    frameGlyph: "🏵️",
  ...
  {
    id: "frame-celestial-heart",
    category: "frame",
    name: "Cœur céleste",
    description: "Petit cœur lumineux, parfait pour les profils chaleureux.",
    icon: "💖",
    currency: "lueurs",
    price: 295,
    frameGlyph: "💖",
  },
  {
    ...
    category: "frame",
    name: "Flamme d'onyx",
    description: "Aura sombre pour les portraits plus intenses.",
    icon: "🔥",
    currency: "sylvins",
    price: 44,
    frameGlyph: "🔥",
  ...
  {
    id: "frame-magic-notes",
    category: "frame",
    name: "Notes magiques",
    description: "Petites notes flottantes pour les créateurs musique.",
    icon: "🎵",
    currency: "lueurs",
    price: 230,
    frameGlyph: "🎵",
